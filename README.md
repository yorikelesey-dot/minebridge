...
- 📢 Автоматическая рассылка новостей из канала
- 📈 Личная статистика пользователя
- 🔎 Inline режим (поиск из любого чата)
...
### 6. Настройка канала для рассылки (опционально)

Если хочешь рассылать новости из Telegram-канала:

1. Создай публичный канал (например: @minebridge)
2. Добавь бота в администраторы канала
3. Получи ID канала через @userinfobot
4. Обнови `src/config.ts`:
   ```typescript
   newsChannelId: -1003753906519, // Твой ID канала
   newsChannelLink: 'https://t.me/minebridge', // Ссылка на канал
   ```

Подробнее: [CHANNEL_SETUP.md](CHANNEL_SETUP.md)
...
- `/channel` - Информация о новостном канале

### Кнопки

- 🔧 **Моды** - Поиск модов с фильтрами
- ✨ **Шейдеры** - Поиск шейдеров
- 🎨 **Ресурспаки** - Поиск ресурспаков
- 🔍 **Поиск** - Кастомный поиск
- 📈 **Моя статистика** - Личная статистика
- 📢 **Канал** - Ссылка на новостной канал
- 📊 **Статистика** - Админ-панель (только для админа)
