// Установка webhook с channel_post
const https = require('https');

const BOT_TOKEN = '8148378911:AAG6pfj30RKYEyzmOHhuOuiY3WTI_zN3bws';

// Используй свой production URL (без preview части)
const WEBHOOK_URL = 'https://minebridge.vercel.app/api/webhook';

console.log('🔧 Устанавливаю webhook с channel_post...');
...
https.get(url, (res) => {
  ...
  res.on('end', () => {
    ...
    if (response.ok) {
      ...
      console.log('\nТеперь проверь:');
      console.log('1. Опубликуй пост в канале @minebridge');
      console.log('2. Проверь, что пользователи получили рассылку');
    } else {
